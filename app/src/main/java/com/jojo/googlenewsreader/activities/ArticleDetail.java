...
public class ArticleDetail extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image = (ImageView)findViewById(R.id.imageViewLandscape);
        ...
        if(NetworkUtil.getConnectivityStatusBoolean(this)){
            image.setImageBitmap(ArticleDetail.image);
        } else {
            image.setBackground(ContextCompat.getDrawable(this, R.drawable.no_image));
        }
